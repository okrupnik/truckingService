...
if ('' !== $slidersOptions && '' !== $slidersOptions && isset($slidersOptions[$module->id])) {
            ...
            <div class=" bd-grid-26">
              <div class="container-fluid">
                <div class="separated-grid row">
                    <div class="carousel slide<?php if ($productsCount <= $_itemsInRow): ?> single<?php endif; ?> <?php echo $params->get ('moduleclass_sfx') ?>">
                <?php
                    if ($headerText) {
                        echo $headerText;
                    }
