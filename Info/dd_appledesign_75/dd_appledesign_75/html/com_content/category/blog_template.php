...
{
    $GLOBALS['designer_settings']['active_paginator'] = 'specific';
...
<div class=" bd-grid-5">
  <div class="container-fluid">
    ...
    <?php
        $leadingItemClass = $itemClass;
        if ('' === $mergedModes)
            $leadingItemClass = $leadingItemClass . preg_replace('/col-(lg|md|sm|xs)-\d+/', 'col-$1-' . 24, $str);
    ?>
    <?php foreach ($this->lead_items as &$item) : ?>
        <div class="<?php echo $leadingItemClass; ?>">
...
<div class=" bd-grid-5">
  <div class="container-fluid">
    ...
    ?>
    <?php $counter++; ?>
    <div class="<?php echo $introItemClass; ?>">
        <div class="bd-griditem-30">
    <?php
        $this->item = &$item;
        echo $this->loadTemplate('item');
