...
<div class=" bd-productreviews-1">
    ...
    <?php
    renderTemplateFromIncludes('review_header_1', array($review));
?>
	
		<?php
    renderTemplateFromIncludes('review_metadata_1', array($review));
?>
	
		<?php
    renderTemplateFromIncludes('review_text_1', array($review));
?>
	
		<?php
    renderTemplateFromIncludes('reviewrating_2', array($review->review_rating, $maxrating));
?>
</div>
                        <?php
                    }
    ...
    <form method="post" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $this->product->virtuemart_product_id . '&virtuemart_category_id=' . $this->product->virtuemart_category_id); ?>" name="reviewForm" id="reviewform">
            ...
            <div class="review-rating">
                ...
                <br/>
                <?php
    renderTemplateFromIncludes('reviewrating_1', array(0, $maxrating));
?>
