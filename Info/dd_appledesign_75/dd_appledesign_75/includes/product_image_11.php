<?php
function product_image_11($productItems) {
    ?>
        ...
        <?php if ($productItems->productImage->imagesExists) : ?>
            ...
            <?php
                ...
                if (is_object($productItems->productImage->image))
                    $imgHtml = $productItems->productImage->image->displayMediaThumb('class=" bd-imagestyles-19"', false);
                else
                    $imgHtml = str_replace('<img', '<img class=" bd-imagestyles-19" ', $productItems->productImage->image);
            ?>
            <a class=" bd-productimage-11" href="<?php echo $productItems->productImage->link; ?>">
                <?php echo $imgHtml; ?>
            </a>
