...
<div class=" bd-language-7" data-responsive-menu="true" data-responsive-levels="">
    ...
    <ul class=" bd-menu-19">
        <?php foreach($list as $language):?>
            ...
            <?php endif; ?>
            <li dir=<?php echo JLanguage::getInstance($language->lang_code)->isRTL() ? '"rtl"' : '"ltr"'?> class=" bd-menuitem-34">
