<?php
function product_image_8($productItems) {
    ?>
        ...
        <?php if ($productItems->productImage->imagesExists) : ?>
            ...
            <?php
                ...
                if (is_object($productItems->productImage->image))
                    $imgHtml = $productItems->productImage->image->displayMediaThumb('class=" bd-imagestyles-16"', false);
                else
                    $imgHtml = str_replace('<img', '<img class=" bd-imagestyles-16" ', $productItems->productImage->image);
            ?>
